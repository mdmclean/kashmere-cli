...
func registerGoalTools(server *sdkmcp.Server, c *api.Client) {
	...
	type createGoalInput struct {
		...
		Allocations []api.Allocation `json:"allocations,omitempty" jsonschema:"Optional target asset allocations, must sum to 100"`
	}
	sdkmcp.AddTool(server, &sdkmcp.Tool{
		Name:        "create_goal",
	...
	type updateGoalInput struct {
		...
		Allocations      []api.Allocation `json:"allocations,omitempty" jsonschema:"New asset allocations, must sum to 100"`
